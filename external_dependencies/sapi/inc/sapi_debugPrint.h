...
// Initialize
   ...
   // Print String
   #define debugPrintChar(string);                  printChar((debugPrint),(string));
   ...
   #define debugPrintHexBitSize(number,bitSize);    printHexBitSize((debugPrint),(number),(bitSize));
   #define debugPrintlnHexBitSize(number,bitSize);  printlnHexBitSize((debugPrint),(number),(bitSize));

   #define debugPrintHex(number);                   printHex((debugPrint),(number));
   #define debugPrintlnHex(number);                 printlnHex((debugPrint),(number));
   ...
   #define debugPrintHexBitSize(number,bitSize);    ;
   #define debugPrintlnHexBitSize(number,bitSize);  ;

   #define debugPrintHex(number);                   ;
   #define debugPrintlnHex(number);                 ;
